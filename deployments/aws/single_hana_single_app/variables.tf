...
variable "hana_image_id" {
  description = "HANA AMI images that are used to create the machines"
  type        = string
}
...
variable "hana_ip" {
  description = "ip address to give to the hana node"
  type        = string
  default     = ""
}
...
variable "hana_data_disks_configuration" {
  ...
  default = {
    ...
    disks_size = "128,128,128,128,128,64,128"
...
variable "app_image_id" {
  description = "App AMI images that are used to create the machines"
  type        = string
}

variable "app_instancetype" {
  description = "The instance type of the App node"
  type        = string
  default     = "r5.large"
}

variable "app_ip" {
  description = "ip address to give to the app node"
  type        = string
  default     = ""
}
